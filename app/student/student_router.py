...
from app.student.student_schema import StudentReqCreate, StudentResponse
from database.student_database import get_db
from app.student.student_service import (create_student ,
                                     show_students,
                                     get_one ,
                                     update_student,
                                     delete_student,
...
def update_student_id(id : int, body : StudentReqCreate ,
                      current_user : Session = Depends(get_current_user), 
                      db : Session = Depends(get_db)):
...
def get_student(current_user =  Depends (get_current_user)):
